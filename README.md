# MinimalistUI
MinimalistUI is a simplist, lightweight Dark-Themed independent UI Project, Supporting Both X11 And Wayland Display Server (Tho extra packages maybe needed to have wayland support), inspired by XFCE4. MinimalistUI too, is available in a .iso format to simplify the installation of MinimalistUI, which is based on Arch Linux, and inspired by EndeavourOS, archinstall command, and Arch Linux itself. These projects ARE still Under WIP. 
